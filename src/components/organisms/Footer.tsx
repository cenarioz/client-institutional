...
import { IoGlobeOutline, IoLogoFacebook, IoLogoInstagram, IoLogoTwitter, IoMap } from "react-icons/io5";
    ...
    <>
      <div className="relative bg-zinc-100 -mt-16 ">
        <div className="w-full">
          ...
          <div className="container mx-auto xs:flex-col px-4 pt-6 pb-6 xs:gap-2 border-t flex justify-between xs:items-center">
            <p>
              © 2023 Cenarioz, Inc
            </p>
            <div className="flex xs:flex-col md:gap-8 xs:gap-2 md:items-center md:content-center">
              ...
              <span className="flex gap-4 items-center content-center">
