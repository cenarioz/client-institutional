  ...
  return (
    <div className="flex bg-white pt-24 pb-20 text-black">
      <div className="flex flex-col top-1/3 left-0 w-full items-center ">
        <div className="text-center container px-4 mx-auto min-w[350px]">
          <h1 className="text-4xl font-bold">
            {t("about.title")}
          </h1>
        </div>
        <div className="text-center container px-4 mx-auto  min-w[350px] pt-6">
          <h4 className="text-2xl font-light text-gray-500 md:px-24">
            {t("about.subTitle")}
          </h4>
        </div>
        <div className="container mx-auto px-4 xs:flex-col md:flex-row flex gap-6 py-24 xs:px-3">
